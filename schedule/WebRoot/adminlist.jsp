...
<jsp:directive.page import="com.bean.Admin" />
<jsp:directive.page import="com.dao.AdminDao" />
<%
...
<html>
    ...
    <body>
		...
		ArrayList<Admin> userlist=(ArrayList<Admin>)admin.SelectAlladmin(); 	
		%>
		<!-- black top bar -->		
		<!-- header -->
		<!-- bread crumbs-->
			...
			<div id="bread-crumbs" class="box">
				...
				<div class="center">
					<div class="box text-shadow">
						<p>
    <a title="" href="../start-here.html">Home</a> &raquo; UserList
						</p>
					</div>
				</div>
			</div>
			...
			%>	
					<div class="list-item box">					
										...
										<div class="block right">
											...
											<p class="desc"><%=user.getPassword() %>.</p>
											<p class="like"><%=user.getCategory() %></p>
										</div>
					</div>
			<%  		
				}
