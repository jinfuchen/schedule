...
<body>
    ...
    <fieldset>
        <legend>SEARCH DORTOR INFORMATION</legend>
        <div class="form-row">
    ...
    <fieldset>
        <legend>SEARCH SERVICE DETAILS</legend>
         <fieldset>
    ...
    <fieldset>
        <legend>SEARCH TIME INFORMATIONS</legend>
        <div class="form-row">
    ...
    <input type="submit" class="submit" value="Search" /> <input class="reset" type="button" value="Reset" onclick="valid.reset(); return false" />
    </form>
    </div>
    <script type="text/javascript">
