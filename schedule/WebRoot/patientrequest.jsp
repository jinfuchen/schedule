...
<body>
    ...
    <fieldset>
        <legend class="optional">REQUEST DOCTOR INFORMATION</legend>
        <div class="form-row">
    ...
    <fieldset>
        <legend class="optional">RUQUEST SERVICE DETAILS</legend>
         <fieldset>
    ...
    <fieldset>
        <legend class="optional">RUQUEST TIME INFORMATIONS</legend>
        <div class="form-row">
    ...
    <input type="submit" class="submit" value="Request" /> <input class="reset" type="button" value="Reset" onclick="valid.reset(); return false" />
    </form>
    </div>
    <script type="text/javascript">
