...
<jsp:directive.page import="com.bean.requestMap" />
<jsp:directive.page import="com.dao.ScheduleDao" />
<%
    ...
    <body>
		<%
			//String keyword = new String(request.getParameter("keyword").getBytes("ISO-8859-1"),"GB2312");
				...
				ArrayList<requestMap> schedulelist=(ArrayList<requestMap>)schedule.selectDoctorSchedule(name);
		%>
		<!-- black top bar -->		
		<!-- header -->
		<!-- bread crumbs-->
			...
			<div id="bread-crumbs" class="box">
				...
				<div class="center">
					<div class="box text-shadow">
						<p>
    <a title="" href="../start-here.html">Home</a> &raquo; ScheduleList
						</p>
					</div>
				</div>
			</div>
		...
		<div id="main-content" class="box">
			...
			<%  
				int i=1;
				for(requestMap schedulereq : schedulelist)
				{
			%>	
					<div class="list-item box">					
										...
										<div class="block right">
											<p class="date">time:&nbsp&nbsp<%=schedulereq.getTime() %></p>
											<p class="title">Schedule Request <%=i++ %></p>
											<p class="desc">
											Doctorname:&nbsp&nbsp<%=schedulereq.getDoctorname() %>&nbsp&nbsp
											PatientName:&nbsp&nbsp<%=schedulereq.getPatientname() %>
											</p>
											<p class="like"><%=schedulereq.getProcess() %></p>
										</div>
					</div>
			<%  		
				}
