...
<jsp:directive.page import="com.bean.Request" />
<jsp:directive.page import="com.dao.RequestDao" />
<%
    ...
    <body>
		<%
			//String keyword = new String(request.getParameter("keyword").getBytes("ISO-8859-1"),"GB2312");
				...
				ArrayList<Request> requestlist=(ArrayList<Request>)requestdao.selectRequest(name);
		%>
		<!-- black top bar -->		
		<!-- header -->
		<!-- bread crumbs-->
			...
			<div id="bread-crumbs" class="box">
				...
				<div class="center">
					<div class="box text-shadow">
						<p>
    <a title="" href="../start-here.html">Home</a> &raquo; RequestList
						</p>
					</div>
				</div>
			</div>
		...
		<div id="main-content" class="box">
			...
			<%  
				for(Request prequest : requestlist)
					if(prequest.getProcess()==1)
				{
			%>	
					<div class="list-item box">					
										...
										<div class="block right">
											<p class="date"> <%=prequest.getDate() %></p>
											<p class="title"><%=prequest.getName() %></p>
											<p class="desc">
											Service:&nbsp <%=prequest.getService() %>&nbsp&nbsp
											Time:&nbsp	<%=prequest.getTime() %>											
											<br/>
											Gender:&nbsp<%=prequest.getGender() %>&nbsp&nbsp
											Language:&nbsp <%=prequest.getLanguage() %>
											</p>
											<p class="like"><%=prequest.getDoctorname() %></p>
										</div>
					</div>
			<%  		
				}
